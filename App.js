        ...
        return (
            ...
            <div className="main"><br/>
                <div className="rounded1">
                    <img src={process.env.PUBLIC_URL + "/img3.jpeg"} className="rounded" width = "50px" height = "50px"/>
                </div>
                <div className="name1">
                     pratii_s05
                </div>
                ...
                <div className="chat1">
                    Hey!!<br/>Hapieee Birthdayyy
                </div><br/>
                <div className="chat2">
                    Thank you soo muchh!!! 
                </div>    <br/>
                <div className="chat3">
                    Soo!!<br/>Where's the party?
                </div>  <br/>
                <div className="chat4">
                    At my home..<br/>Be there at sharp 5:00
                </div> <br/>
                <div className="chat5">
                    Sure..meet you soon:)    
                </div> 
